...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "ETC.NSRWS1D.compute_core",
        "sources": [
            "ETC/NSRWS1D/compute_core.pyx"
        ]
    },
    "module_name": "ETC.NSRWS1D.compute_core"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ETC__NSRWS1D__compute_core
#define __PYX_HAVE_API__ETC__NSRWS1D__compute_core
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'ETC.NSRWS1D.compute_core' */
...
static arrayobject *__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_pairs(__Pyx_memviewslice, __Pyx_memviewslice, unsigned int, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_3ETC_7NSRWS1D_12compute_core_check_equality(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static arrayobject *__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_windows(__Pyx_memviewslice, unsigned int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_windows(__Pyx_memviewslice, unsigned int, __Pyx_memviewslice, unsigned int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "ETC.NSRWS1D.compute_core"
extern int __pyx_module_is_main_ETC__NSRWS1D__compute_core;
int __pyx_module_is_main_ETC__NSRWS1D__compute_core = 0;

/* Implementation of 'ETC.NSRWS1D.compute_core' */
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_2substitute_pairs(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_pair, unsigned int __pyx_v_value); /* proto */
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_4check_equality(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_6get_mask_windows(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order); /* proto */
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_8substitute_windows(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order, __Pyx_memviewslice __pyx_v_window, unsigned int __pyx_v_value); /* proto */
...
/* "ETC/NSRWS1D/compute_core.pyx":15
 * 
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_1get_mask_pairs(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static arrayobject *__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":29
 *     """
 *     # Get size of input
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":32
 * 
 *     # Initialize a mask of Falses
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":33
 *     # Initialize a mask of Falses
 *     cdef array.array int_template = array.array('I', [])
 *     cdef array.array mask = array.clone(int_template, x_size, zero=True)             # <<<<<<<<<<<<<<
 *     cdef unsigned int[:] mask_view = mask
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":34
 *     cdef array.array int_template = array.array('I', [])
 *     cdef array.array mask = array.clone(int_template, x_size, zero=True)
 *     cdef unsigned int[:] mask_view = mask             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":37
 * 
 *     # Initialize bounds for iteration
 *     cdef Py_ssize_t n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":40
 * 
 *     # Turn all values in mask to Trues
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":41
 *     # Turn all values in mask to Trues
 *     for n in range(x_size):
 *         mask_view[n] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":44
 * 
 *     # Iterate over all values of input
 *     n = 0             # <<<<<<<<<<<<<<
 *     while n < x_size - 1:
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":45
 *     # Iterate over all values of input
 *     n = 0
 *     while n < x_size - 1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  while (1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":48
 * 
 *         # If successive pairs match
 ...
 */
    ...
    __pyx_t_12 = (((*((unsigned int const  *) ( /* dim=0 */ ((char *) (((unsigned int const  *) __pyx_v_x.data) + __pyx_t_10)) ))) == (*((unsigned int const  *) ( /* dim=0 */ ((char *) (((unsigned int const  *) __pyx_v_x.data) + __pyx_t_11)) )))) != 0);
    if (__pyx_t_12) {
    } else {
    ...
    if (__pyx_t_9) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":51
 * 
 *             # Mask out the second one
 *             mask_view[n+1] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((unsigned int *) ( /* dim=0 */ (__pyx_v_mask_view.data + __pyx_t_10 * __pyx_v_mask_view.strides[0]) )) = 0;
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":54
 * 
 *             # And slide over it
 *             n += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":57
 * 
 *         # Increment while loop index
 *         n += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":59
 *         n += 1
 * 
 *     return mask             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("ETC.NSRWS1D.compute_core.get_mask_pairs", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_1get_mask_pairs(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static char __pyx_doc_3ETC_7NSRWS1D_12compute_core_get_mask_pairs[] = "get_mask_pairs(const unsigned int[::1] x) -> array\n\n    INPUT\n    -----\n    x : array.array\n        Array object containing 32-bit integers.\n\n    OUTPUT\n    ------\n    mask : array.array\n        Array object containing 32-bit integers - 0s or 1s corresponding to values in\n        x for which successive overlapping pairs occur.\n    ";
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_1get_mask_pairs(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  ...
  __pyx_r = __pyx_pf_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_pairs(__pyx_v_x, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
...
/* "ETC/NSRWS1D/compute_core.pyx":62
 * 
 * # Function for substituting pairs
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_3substitute_pairs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_pairs(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_pair, unsigned int __pyx_v_value, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_x_size;
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":82
 *     """
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":83
 *     # Initialize looping variables and output list
 *     cdef Py_ssize_t n = 0
 *     cdef Py_ssize_t x_size = len(x)             # <<<<<<<<<<<<<<
 *     cdef list out = []
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":84
 *     cdef Py_ssize_t n = 0
 *     cdef Py_ssize_t x_size = len(x)
 *     cdef list out = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":87
 * 
 *     # Loop over input and replace pair
 *     while n < x_size-1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  while (1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":90
 * 
 *         # Check for match with supplied pair
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":93
 * 
 *             # Replace first value with supplied value
 *             x[n] = value             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_x.data) + __pyx_t_4)) )) = __pyx_v_value;
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":96
 * 
 *             # Replace second value with 0
 *             x[n+1] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_x.data) + __pyx_t_5)) )) = 0;
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":98
 *             x[n+1] = 0
 * 
 *             n += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":100
 *             n += 1
 * 
 *         n += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":103
 * 
 *     # Reset indexing variable
 *     n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":106
 * 
 *     # Loop over mutated input and append non-zero values to list
 *     for n in range(x_size):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":108
 *     for n in range(x_size):
 * 
 *         if x[n]:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":110
 *         if x[n]:
 * 
 *             out.append(x[n])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":112
 *             out.append(x[n])
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("ETC.NSRWS1D.compute_core.substitute_pairs", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_3substitute_pairs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3ETC_7NSRWS1D_12compute_core_2substitute_pairs(__pyx_self, __pyx_v_x, __pyx_v_pair, __pyx_v_value);
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_2substitute_pairs(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_pair, unsigned int __pyx_v_value) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("substitute_pairs", 0);
  ...
  __pyx_t_1 = __pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_pairs(__pyx_v_x, __pyx_v_pair, __pyx_v_value, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "ETC/NSRWS1D/compute_core.pyx":115
 * 
 * # Function for checking whether all elements in input are identical
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_5check_equality(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static int __pyx_f_3ETC_7NSRWS1D_12compute_core_check_equality(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_x_size;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":130
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":133
 * 
 *     # Iterate over values from input
 *     for n in range(x_size):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":136
 * 
 *         # Short-circuit the loop: check for any element that doesn't equal the first
 *         if x[0] != x[n]:             # <<<<<<<<<<<<<<
 *             return False
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":137
 *         # Short-circuit the loop: check for any element that doesn't equal the first
 *         if x[0] != x[n]:
 *             return False             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":139
 *             return False
 * 
 *     return True             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_5check_equality(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static char __pyx_doc_3ETC_7NSRWS1D_12compute_core_4check_equality[] = "check_equality(const unsigned int[::1] x) -> bool\n\n    INPUT\n    -----\n    x : array.array\n        Array object containing 32-bit unsigned integers.\n\n\n    OUTPUT\n    ------\n    bool\n        True if all elements are identical\n    ";
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_5check_equality(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("ETC.NSRWS1D.compute_core.check_equality", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3ETC_7NSRWS1D_12compute_core_4check_equality(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_4check_equality(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("check_equality", 0);
  ...
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_f_3ETC_7NSRWS1D_12compute_core_check_equality(__pyx_v_x, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 115, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "ETC/NSRWS1D/compute_core.pyx":142
 * 
 * # Function for getting mask for windows of any length
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_7get_mask_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static arrayobject *__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_windows(__Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_x_size;
  arrayobject *__pyx_v_int_template = 0;
  arrayobject *__pyx_v_mask = 0;
  __Pyx_memviewslice __pyx_v_mask_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":159
 *     """
 *     # Get size of input
 *     cdef Py_ssize_t x_size = len(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":162
 * 
 *     # Initialize a mask of Falses
 *     cdef array.array int_template = array.array('I', [])             # <<<<<<<<<<<<<<
 *     cdef array.array mask = array.clone(int_template, x_size, zero=True)
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":163
 *     # Initialize a mask of Falses
 *     cdef array.array int_template = array.array('I', [])
 *     cdef array.array mask = array.clone(int_template, x_size, zero=True)             # <<<<<<<<<<<<<<
 *     cdef unsigned int[:] mask_view = mask
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":164
 *     cdef array.array int_template = array.array('I', [])
 *     cdef array.array mask = array.clone(int_template, x_size, zero=True)
 *     cdef unsigned int[:] mask_view = mask             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":167
 * 
 *      # Initialize variable for iteration
 *     cdef Py_ssize_t n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":170
 * 
 *     # Turn all values in mask to Trues
 *     for n in range(x_size):             # <<<<<<<<<<<<<<
 *         mask_view[n] += 1
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":171
 *     # Turn all values in mask to Trues
 *     for n in range(x_size):
 *         mask_view[n] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":174
 * 
 *     # Initialize variables for iteration across input
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":175
 *     # Initialize variables for iteration across input
 *     cdef Py_ssize_t k = 0 # Outer loop
 *     cdef Py_ssize_t m = 0 # Inner loop             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":178
 * 
 *     # Tracking variable for counting matching elements in pairwise window comparison
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":181
 * 
 *     # Iterate over input values except the last 'order' values [Outermost master loop]
 *     n = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":182
 *     # Iterate over input values except the last 'order' values [Outermost master loop]
 *     n = 0
 *     for n in range(x_size-order):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":185
 * 
 *         # proceed only if mask is True for current element
 *         if mask_view[n]:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_10) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":188
 * 
 *             # Outer loop for sliding the 'next' window by unit step (current vs next)
 ...
 */
      ...
      for (__pyx_t_13 = 1; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        ...
        /* "ETC/NSRWS1D/compute_core.pyx":191
 * 
 *                 # Inner loop for comparing elements in current and next windows
 ...
 */
        ...
        for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
          ...
          /* "ETC/NSRWS1D/compute_core.pyx":194
 * 
 *                     # If elements match, increment tracker
 *                     if x[n+m] == x[n+m+k]:             # <<<<<<<<<<<<<<
 *                         track += 1
 ...
 */
          ...
          if (__pyx_t_10) {
            ...
            /* "ETC/NSRWS1D/compute_core.pyx":195
 *                     # If elements match, increment tracker
 *                     if x[n+m] == x[n+m+k]:
 *                         track += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "ETC/NSRWS1D/compute_core.pyx":199
 *                     # Else stop iteration over this comparison of windows
 *                     else:
 *                         break             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "ETC/NSRWS1D/compute_core.pyx":203
 *                 # Trick: preserve mask only if track doesn't equal order
 ...
 */
        ...
        *((unsigned int *) ( /* dim=0 */ (__pyx_v_mask_view.data + __pyx_t_17 * __pyx_v_mask_view.strides[0]) )) = __pyx_t_14;
        ...
        /* "ETC/NSRWS1D/compute_core.pyx":206
 * 
 *                 # Reset tracker
 *                 track = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":208
 *                 track = 0
 * 
 *     return mask             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __PYX_XDEC_MEMVIEW(&__pyx_t_4, 1);
  __Pyx_AddTraceback("ETC.NSRWS1D.compute_core.get_mask_windows", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF((PyObject *)__pyx_v_int_template);
  __Pyx_XDECREF((PyObject *)__pyx_v_mask);
...
/* Python wrapper */
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_7get_mask_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3ETC_7NSRWS1D_12compute_core_6get_mask_windows[] = "get_mask_windows(const unsigned int[::1] x, unsigned int order) -> array\n\n    INPUT\n    -----\n    x : array.array\n        Array object containing 32-bit integers.\n\n    order: unsigned 32-bit int\n        Length of the window to slide across input\n\n    OUTPUT\n    ------\n    mask : array.array\n        Array object containing 32-bit integers - 0s or 1s corresponding to values in\n        x for which successive overlapping pairs occur.\n    ";
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_7get_mask_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3ETC_7NSRWS1D_12compute_core_6get_mask_windows(__pyx_self, __pyx_v_x, __pyx_v_order);
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_6get_mask_windows(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_mask_windows", 0);
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_3ETC_7NSRWS1D_12compute_core_get_mask_windows(__pyx_v_x, __pyx_v_order, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "ETC/NSRWS1D/compute_core.pyx":211
 * 
 * # Function for substituting windows of any length
...
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_9substitute_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_windows(__Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order, __Pyx_memviewslice __pyx_v_window, unsigned int __pyx_v_value, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_n;
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_x_size;
  PyObject *__pyx_v_out = 0;
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":234
 *     """
 *     # Initialize looping variables and output list
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":235
 *     # Initialize looping variables and output list
 *     cdef Py_ssize_t n = 0 # Outer loop
 *     cdef Py_ssize_t m = 0 # Inner loop             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t x_size = len(x)
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":236
 *     cdef Py_ssize_t n = 0 # Outer loop
 *     cdef Py_ssize_t m = 0 # Inner loop
 *     cdef Py_ssize_t x_size = len(x)             # <<<<<<<<<<<<<<
 *     cdef list out = []
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":237
 *     cdef Py_ssize_t m = 0 # Inner loop
 *     cdef Py_ssize_t x_size = len(x)
 *     cdef list out = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":240
 * 
 *     # Tracking variable for counting matching elements in pairwise window comparison
 *     cdef unsigned int track = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":244
 *     # Iterate over input values except one less than the last 'order' values
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":247
 * 
 *         # Slide window of given order and do element-wise comparison
 *         for m in range(order):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":253
 * 
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "ETC/NSRWS1D/compute_core.pyx":254
 *             # Track comparison of input elements with window elements
 *             if x[n+m] == window[m]:
 *                 track += 1             # <<<<<<<<<<<<<<
 *             # # If mismatch, break
 ...
 */
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":257
 *             # # If mismatch, break
 *             else:
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":260
 * 
 *         # If all compared elements match for current window
 *         if track == order:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":263
 * 
 *             # Replace the first element with provided value
 *             x[n] = value             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_x.data) + __pyx_t_10)) )) = __pyx_v_value;
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":266
 * 
 *             # Replace the remaining subsequent values with zeros
 ...
 */
      ...
      for (__pyx_t_8 = 1; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "ETC/NSRWS1D/compute_core.pyx":267
 *             # Replace the remaining subsequent values with zeros
 *             for m in range(1, order):
 *                 x[n+m] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":270
 * 
 *         # Reset tracker
 *         track = 0             # <<<<<<<<<<<<<<
 *     # Reset indexing variable
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":272
 *         track = 0
 *     # Reset indexing variable
 *     n = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":275
 * 
 *     # Loop over mutated input and append non-zero values to list
 *     for n in range(x_size):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "ETC/NSRWS1D/compute_core.pyx":277
 *     for n in range(x_size):
 * 
 *         if x[n]:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "ETC/NSRWS1D/compute_core.pyx":279
 *         if x[n]:
 * 
 *             out.append(x[n])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":281
 *             out.append(x[n])
 * 
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("ETC.NSRWS1D.compute_core.substitute_windows", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_out);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_9substitute_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3ETC_7NSRWS1D_12compute_core_8substitute_windows[] = "substitute_windows(unsigned int[::1] x, unsigned int order, unsigned int[::1] window, unsigned int value) -> list\n\n    INPUT\n    -----\n    x : array.array\n        Array object containing 32-bit unsigned integers.\n\n    order: unsigned 32-bit int\n        Length of the window to slide across input\n\n    window : array.array, length = 2\n        Array object containing 2 32-bit unsigned integers.\n\n    value : unsigned 32-bit int\n        Value to substitute the first element of pair with\n\n    OUTPUT\n    ------\n    out : list\n        Array object containing 32-bit integers, with supplied pair replaced everywhere\n        by the supplied value.\n    ";
static PyObject *__pyx_pw_3ETC_7NSRWS1D_12compute_core_9substitute_windows(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_order;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3ETC_7NSRWS1D_12compute_core_8substitute_windows(__pyx_self, __pyx_v_x, __pyx_v_order, __pyx_v_window, __pyx_v_value);
...
static PyObject *__pyx_pf_3ETC_7NSRWS1D_12compute_core_8substitute_windows(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, unsigned int __pyx_v_order, __Pyx_memviewslice __pyx_v_window, unsigned int __pyx_v_value) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("substitute_windows", 0);
  ...
  __pyx_t_1 = __pyx_f_3ETC_7NSRWS1D_12compute_core_substitute_windows(__pyx_v_x, __pyx_v_order, __pyx_v_window, __pyx_v_value, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 211, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "ETC.NSRWS1D.compute_core.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "ETC.NSRWS1D.compute_core.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "ETC.NSRWS1D.compute_core.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "ETC.NSRWS1D.compute_core._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_mask_pairs", (PyCFunction)__pyx_pw_3ETC_7NSRWS1D_12compute_core_1get_mask_pairs, METH_O, __pyx_doc_3ETC_7NSRWS1D_12compute_core_get_mask_pairs},
  {"substitute_pairs", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3ETC_7NSRWS1D_12compute_core_3substitute_pairs, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3ETC_7NSRWS1D_12compute_core_2substitute_pairs},
  {"check_equality", (PyCFunction)__pyx_pw_3ETC_7NSRWS1D_12compute_core_5check_equality, METH_O, __pyx_doc_3ETC_7NSRWS1D_12compute_core_4check_equality},
  {"get_mask_windows", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3ETC_7NSRWS1D_12compute_core_7get_mask_windows, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3ETC_7NSRWS1D_12compute_core_6get_mask_windows},
  {"substitute_windows", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3ETC_7NSRWS1D_12compute_core_9substitute_windows, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3ETC_7NSRWS1D_12compute_core_8substitute_windows},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_ETC__NSRWS1D__compute_core) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ETC.NSRWS1D.compute_core")) {
      if (unlikely(PyDict_SetItemString(modules, "ETC.NSRWS1D.compute_core", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":12
 ...
 */
  ...
  /* "ETC/NSRWS1D/compute_core.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ETC.NSRWS1D.compute_core", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ETC.NSRWS1D.compute_core");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
