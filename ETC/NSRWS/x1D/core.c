 ...
 * 
 */
          __pyx_t_10 = ((((__pyx_v_n + __pyx_v_m) + __pyx_v_k) >= __pyx_v_x_size) != 0);
          if (__pyx_t_10) {
 ...
 */
      __pyx_t_12 = __pyx_v_n;
      __pyx_t_2 = __Pyx_PyInt_From_unsigned_int((*((unsigned int *) ( /* dim=0 */ ((char *) (((unsigned int *) __pyx_v_x.data) + __pyx_t_12)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 282, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_out, __pyx_t_2); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 282, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
